...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: a flex item's automatic minimum size is its content's, so
        // without this any page with something wider than the viewport in it —
        // a ledger table, a wide chart — stretches the whole shell instead of
        // scrolling inside its own box, and the body scrolls sideways.
