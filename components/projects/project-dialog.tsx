  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-3xl">
        ...
        {/* Outside the mode switch, so it survives one: a confirmation panel
            that belongs to whichever body is showing would be unmounted by the
            very click that opened it. */}
        {confirmDelete && project && (
          <div className="flex flex-col gap-3 rounded-lg bg-destructive/10 p-3 text-sm">
            <p className="text-destructive">
              Delete {project.salesOrderNo} — {project.name}? It comes out of
              the monthly and yearly totals, and this can&apos;t be undone.
            </p>
        ...
        <DialogFooter className="sm:justify-between">
          {editing ? (
            <Button
              ...
              // Disabled rather than hidden while confirming, for the same
              // reason the footer is shared.
